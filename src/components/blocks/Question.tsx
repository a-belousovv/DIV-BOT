			...
			content: [
				{
					id: '3',
					title:
						'Доступ к персональному “тренеру” в твоем телефоне с индивидуальным подходом Подписка стоит как одна тренировка с тренером, а приносить ценности в 10 раз выше Чат с ребятами, которых объединяет одна цель, вот что говорят о моих бесплатных продуктах👇',
					imgs: [
			...
			content: [
				{
					id: '5',
					title:
						'Подписка будет продлеваться автоматически при начилии средств на карте. Ты можешь остановить подписку в любой момент 👇',
